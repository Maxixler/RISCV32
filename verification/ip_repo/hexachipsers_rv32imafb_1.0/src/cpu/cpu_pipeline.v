...
(
    ...
    output wire [ 5:0] EX_ALU_FUNC,  // ALU Function in EX Stage
...
assign EX_ALU_FUNC  = (1'b1         )? ex_alu_func  :  6'h0;
...
32'b0000100_?????_?????_000_?????_0111011: // ADD.UW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ADD_UW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0100000_?????_?????_111_?????_0110011: // ANDN
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ANDN;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0100100_?????_?????_001_?????_0110011: // BCLR
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_BCLR;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0100100_?????_?????_001_?????_0010011: // BCLRI
begin
    id_alu_src1  = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_shamt = pipe_id_code[24:20];
    id_alu_dst1  = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func  = `ALUFUNC_BCLRI;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0100100_?????_?????_101_?????_0110011: // BEXT
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_BEXT;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0100100_?????_?????_101_?????_0010011: // BEXTI
begin
    id_alu_src1  = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_shamt = pipe_id_code[24:20];
    id_alu_dst1  = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func  = `ALUFUNC_BEXTI;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110100_?????_?????_001_?????_0110011: // BINV
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_BINV;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110100_?????_?????_001_?????_0010011: // BINVI
begin
    id_alu_src1  = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_shamt = pipe_id_code[24:20];
    id_alu_dst1  = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func  = `ALUFUNC_BINVI;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010100_?????_?????_001_?????_0110011: // BSET
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_BSET;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010100_?????_?????_001_?????_0010011: // BSETI
begin
    id_alu_src1  = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_shamt = pipe_id_code[24:20];
    id_alu_dst1  = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func  = `ALUFUNC_BSETI;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0000101_?????_?????_001_?????_0110011: // CLMUL
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CLMUL;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0000101_?????_?????_011_?????_0110011: // CLMULH
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CLMULH;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0000101_?????_?????_010_?????_0110011: // CLMULR
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CLMULR;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000000_?????_001_?????_0010011: // CLZ
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CLZ;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000000_?????_001_?????_0011011: // CLZW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CLZW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000010_?????_001_?????_0010011: // CPOP
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CPOP;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000010_?????_001_?????_0011011: // CPOPW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CPOPW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000001_?????_001_?????_0010011: // CTZ
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CTZ;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000001_?????_001_?????_0011011: // CTZW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_CTZW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0000101_?????_?????_110_?????_0110011: // MAX
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_MAX;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0000101_?????_?????_111_?????_0110011: // MAXU
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_MAXU;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0000100_?????_?????_100_?????_0110011: // MIN
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_MIN;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0000101_?????_?????_101_?????_0110011: // MINU
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_MINU;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b001010000111_?????_101_?????_0010011: // ORC.B
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ORC_B;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0100000_?????_?????_110_?????_0110011: // ORN
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ORN;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011010011000_?????_101_?????_0010011: // REV8
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_REV8;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110000_?????_?????_001_?????_0110011: // ROL
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ROL;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110000_?????_?????_001_?????_0111011: // ROLW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ROLW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110000_?????_?????_101_?????_0110011: // ROR
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ROR;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110000_?????_?????_101_?????_0010011: // RORI
begin
    id_alu_src1  = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_shamt = pipe_id_code[24:20];
    id_alu_dst1  = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func  = `ALUFUNC_RORI;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110000_?????_?????_101_?????_0011011: // RORIW
begin
    id_alu_src1  = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_shamt = pipe_id_code[24:20];
    id_alu_dst1  = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func  = `ALUFUNC_RORIW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0110000_?????_?????_101_?????_0111011: // RORW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_RORW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000100_?????_001_?????_0010011: // SEXT.B
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SEXT_B;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b011000000101_?????_001_?????_0010011: // SEXT.H
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SEXT_H;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010000_?????_?????_010_?????_0110011: // SH1ADD
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SH1ADD;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010000_?????_?????_010_?????_0111011: // SH1ADD.UW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SH1ADD_UW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010000_?????_?????_100_?????_0110011: // SH2ADD
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SH2ADD;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010100_?????_?????_100_?????_0111011: // SH2ADD.UW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SH2ADD_UW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010000_?????_?????_110_?????_0110011: // SH3ADD
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SH3ADD;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0010000_?????_?????_110_?????_0111011: // SH3ADD.UW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SH3ADD_UW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b000010_??????_?????_001_?????_0011011: // SLLI.UW
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_IMM | {27'h0, pipe_id_code[25:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_SLLI_UW;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b0100000_?????_?????_100_?????_0110011: // XNOR
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_GPR | {9'h0, pipe_id_code[24:20]};
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_XNOR;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
end
32'b000010000000_?????_100_?????_0110011: // ZEXT.H
begin
    id_alu_src1 = `ALU_GPR | {9'h0, pipe_id_code[19:15]};
    id_alu_src2 = `ALU_NONE;
    id_alu_dst1 = `ALU_GPR | {9'h0, pipe_id_code[11:7]};
    id_alu_func = `ALUFUNC_ZEXT_H;
    state_id_ope_nxt = `STATE_ID_DECODE_NORMAL;
    state_id_ope_upd = 1'b1;
    decode_stp   = 1'b1;
    decode_ack   = 1'b1;
                        ...
                        begin
                            id_fpu_cmd  = `FPU32_CMD_FSW;
                            id_fpu_src1 = `ALU_FPR | {9'h0, pipe_id_code[6:2]}; // FPR source
                            id_alu_src1 = `ALU_GPR | {9'h0, 5'b00010}; // x2
                            id_alu_src2 = `ALU_IMM;
                            id_alu_imm  = IMM_CSWSPU(pipe_id_code); // FF
                            id_alu_func = `ALUFUNC_ADD;
