...
`define MISA_B    32'h00000002 // Bit Manipulation
...
`define ALUFUNC_SUB  6'b001000
`define ALUFUNC_SLL  6'b000001 // shift left logical
`define ALUFUNC_SLLI 6'b010001 // shift left logical by shamnt
`define ALUFUNC_SLT  6'b000010 // set less than signed
`define ALUFUNC_SLTU 6'b000011 // set less than unsigned
`define ALUFUNC_XOR  6'b000100
`define ALUFUNC_SRL  6'b000101 // shift right logical
`define ALUFUNC_SRLI 6'b010101 // shift right logical by shamnt
`define ALUFUNC_SRA  6'b001101 // shift right arithmetic
`define ALUFUNC_SRAI 6'b011101 // shift right arithmetic by shamnt
`define ALUFUNC_OR   6'b000110
`define ALUFUNC_AND  6'b000111
`define ALUFUNC_SWAP 6'b011001 // Swap for CSRRW/CSRRWI
`define ALUFUNC_SWPS 6'b011010 // Swap and Bit Set for CSRRS/CSRRSI
`define ALUFUNC_SWPC 6'b011011 // Swap and Bit Clr for CSRRC/CSRRCI
`define ALUFUNC_MINS 6'b001001 // Minimum Signed
`define ALUFUNC_MAXS 6'b001010 // Maximum Signed
`define ALUFUNC_MINU 6'b001011 // Minimum Unsigned
`define ALUFUNC_MAXU 6'b001100 // Maximum Unsigned 
`define ALUFUNC_BUSX 6'b001110 // aluout = busX
`define ALUFUNC_BUSY 6'b001111 // aluout = busY
//                   5'b10000
//                   5'b10010
//                   5'b10011
//                   5'b10100
...
// Bit Manipulation
//----------------------
`define ALUFUNC_ADD_UW    6'b010000
`define ALUFUNC_ANDN      6'b010010
`define ALUFUNC_BCLR      6'b010011
`define ALUFUNC_BCLRI     6'b010100
`define ALUFUNC_BEXT      6'b010110
`define ALUFUNC_BEXTI     6'b010111
`define ALUFUNC_BINV      6'b011000
`define ALUFUNC_BINVI     6'b011001
`define ALUFUNC_BSET      6'b011100
`define ALUFUNC_BSETI     6'b011110
`define ALUFUNC_CLMUL     6'b011111
`define ALUFUNC_CLMULH    6'b100000
`define ALUFUNC_CLMULR    6'b100001
`define ALUFUNC_CLZ       6'b100010
`define ALUFUNC_CLZW      6'b100011
`define ALUFUNC_CPOP      6'b100100
`define ALUFUNC_CPOPW     6'b100101
`define ALUFUNC_CTZ       6'b100110
`define ALUFUNC_CTZW      6'b100111
`define ALUFUNC_MAX       6'b101000
`define ALUFUNC_MAXU_     6'b101001
`define ALUFUNC_MIN       6'b101010
`define ALUFUNC_MINU_     6'b101011
`define ALUFUNC_ORC_B     6'b101100
`define ALUFUNC_ORN       6'b101101
`define ALUFUNC_REV8      6'b101110
`define ALUFUNC_ROL       6'b101111
`define ALUFUNC_ROLW      6'b110000
`define ALUFUNC_ROR       6'b110001
`define ALUFUNC_RORI      6'b110010
`define ALUFUNC_RORIW     6'b110011
`define ALUFUNC_RORW      6'b110100
`define ALUFUNC_SEXT_B    6'b110101
`define ALUFUNC_SEXT_H    6'b110110
`define ALUFUNC_SH1ADD    6'b110111
`define ALUFUNC_SH1ADD_UW 6'b111000
`define ALUFUNC_SH2ADD    6'b111001
`define ALUFUNC_SH2ADD_UW 6'b111010
`define ALUFUNC_SH3ADD    6'b111011
`define ALUFUNC_SH3ADD_UW 6'b111100
`define ALUFUNC_SLLI_UW	  6'b111101
`define ALUFUNC_XNOR      6'b111110
`define ALUFUNC_ZEXT_H    6'b111111

`define ALU_NONE 6'b000000
